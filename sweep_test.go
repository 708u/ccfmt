...
func TestBashToolSweeperShouldSweep(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:      "all paths dead",
			sweeper:   &BashToolSweeper{active: true, checker: testutil.NoPathsExist{}, excluder: noExcludes},
			specifier: "git -C /dead/repo status",
			wantSweep: true,
		},
		{
			name:      "one path alive",
			sweeper:   &BashToolSweeper{active: true, checker: testutil.CheckerFor("/alive/src"), excluder: noExcludes},
		...
		},
		{
			...
			sweeper:   &BashToolSweeper{active: true, checker: testutil.AllPathsExist{}, excluder: noExcludes},
		...
		},
		{
			...
			sweeper:   &BashToolSweeper{active: true, checker: testutil.NoPathsExist{}, homeDir: "/home/user", excluder: noExcludes},
			specifier: "cat ~/dead/config",
			wantSweep: true,
		},
		{
			name:      "tilde path alive with homeDir",
			sweeper:   &BashToolSweeper{active: true, checker: testutil.CheckerFor("/home/user/alive/config"), homeDir: "/home/user", excluder: noExcludes},
		...
		},
		{
			...
			sweeper:   &BashToolSweeper{active: true, checker: testutil.NoPathsExist{}, baseDir: "/project", excluder: noExcludes},
		...
		},
		{
			...
			sweeper:   &BashToolSweeper{active: true, checker: testutil.NoPathsExist{}, homeDir: "/home/user", baseDir: "/project", excluder: noExcludes},
			specifier: "cp /dead/src ./dead/dst",
			wantSweep: true,
		},
		{
			name:      "mixed absolute and relative one alive",
			sweeper:   &BashToolSweeper{active: true, checker: testutil.CheckerFor("/alive/src"), homeDir: "/home/user", baseDir: "/project", excluder: noExcludes},
			specifier: "cp /alive/src ./dead/dst",
			wantSweep: false,
		},
		{
...
func TestBashToolSweeperWithExcluder(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			sweeper:   &BashToolSweeper{active: true, checker: testutil.NoPathsExist{}, excluder: excl},
